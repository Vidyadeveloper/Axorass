            ...
            class ClientOnboardingLaunchKickoff extends HTMLElement {
         constructor() {
    super();
...
customElements.define("client-onboarding-launch-kickoff", ClientOnboardingLaunchKickoff);
export default ClientOnboardingLaunchKickoff;
